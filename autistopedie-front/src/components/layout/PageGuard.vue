<template>
    <div class="classic-container pageguard-container">
        <div class="content-group">
            <h2>Accès interdit</h2>
            <p>
                Bonjour, vous ne pouvez pas accéder à cette page si vous ne disposez pas d'un compte utilisateur avec le rôle "contributeur.ice" ou
                "adminitrateur.ice".
            </p>
            <p>
                Si vous souhaitez obtenir l'un de ces rôles, vous pouvez créer un compte sur le site et
                <RouterLink to="/contribuer">contacter l'administrateur.</RouterLink>
            </p>
        </div>

        <div class="content-group center-content vertical">
            <div class="frame">
                <!-- CROW -->
                <!-- Head -->
        ...
        <p class="guard-subtext">Illustration réalisée en Scss à partir du héro du jeu <a href="https://playdeathsdoor.com/" title="Voir la présentation du jeu" target="_blank">@Death's Door.</a></p>
    </div>
</template>
...
.c-head {
    ...
    box-shadow: 0 0.25rem 0.25rem rgba(255, 255, 255, 0.8) inset;
...
.c-beak {
    ...
    width: 3rem;
    height: 1.25rem;
    background: linear-gradient(-90deg, #3b1731, #818794);
...
.cn-left {
    ...
    box-shadow: -0.75rem 0 0.15rem $grey-02 inset;
    top: 5.5rem;
    left: 6.5rem;
}
...
.c-body {
    ...
    width: 8rem;
    height: 10rem;
    border-radius: 2.5rem 3rem 5rem 5rem;
...
.ca-left {
    border-radius: 5rem 0 6rem 0.5rem;
...
.ca-right {
    border-radius: 0 5rem 0.5rem 6rem;
...
.s-handle-magic {
    ...
    height: 0.4rem;
    border-radius: 100%;
    background: radial-gradient($white, $pink-01);
}
...
.s-blade-magic {
    ...
    width: 0.5rem;
    height: 4.5rem;
    background: linear-gradient(0.25turn, $pink-02, $pink-01, $pink-02);
}
